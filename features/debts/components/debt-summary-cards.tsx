  ...
  const cards = [
    {
      ...
      subtitle: `${data.activeDebtCount} Active Debts`,
    ...
    },
    {
      ...
      subtitle: `${data.averageProgressPercentage.toFixed(1)}% Avg Progress`,
    ...
    },
    {
      ...
      subtitle: `${data.inactiveDebtCount} Inactive, ${data.defaultedDebtCount} Defaulted`,
