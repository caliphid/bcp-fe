import { SalesByCategoryRow } from "../../../../types/order-dashboard";
...
export function SalesByCategoryTable({ data, loading, meta, page, limit, setPage, sortBy, sortOrder, handleSort }: Props) {
