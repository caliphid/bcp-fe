import { SalesByProductVariantRow } from "../../../../types/order-dashboard";
...
export function SalesByVariantTable({ data, loading, meta, page, limit, setPage, sortBy, sortOrder, handleSort }: Props) {
