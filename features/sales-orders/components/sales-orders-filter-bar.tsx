    ...
    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 space-y-4">
      <div className="flex flex-col md:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <Input
            placeholder={t("features.salesOrders.filterBar.searchPh")}
            value={localSearch}
      ...
      {showAdvanced && (
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 pt-4 border-t border-slate-100 animate-in slide-in-from-top-2 fade-in duration-200">
          <div>
            ...
            >
              <option value="">{t("features.salesOrders.filterBar.allStatus")}</option>
          ...
          <div>
            <label className="text-xs font-semibold text-slate-500 mb-1.5 block">{t("features.salesOrders.filterBar.salesChannel")}</label>
            <Input
              placeholder={t("features.salesOrders.filterBar.salesChannelPh")}
          ...
          <div>
            <label className="text-xs font-semibold text-slate-500 mb-1.5 block">{t("features.salesOrders.filterBar.orderType")}</label>
            <Input
              placeholder={t("features.salesOrders.filterBar.orderTypePh")}
          ...
          <div>
            <label className="text-xs font-semibold text-slate-500 mb-1.5 block">{t("features.salesOrders.filterBar.dateFrom")}</label>
            <Input
              type="date"
          ...
          <div>
            <label className="text-xs font-semibold text-slate-500 mb-1.5 block">{t("features.salesOrders.filterBar.dateTo")}</label>
            <Input
              type="date"
          ...
          {user?.role === 'OWNER' && (
            <div>
              <label className="text-xs font-semibold text-slate-500 mb-1.5 block">{t("features.salesOrders.filterBar.businessUnitId")}</label>
              <Input
